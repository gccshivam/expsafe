    ...
    <div className="min-h-screen w-full overflow-hidden bg-gradient-to-br from-blue-50 to-cyan-50">
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col items-center justify-center">
                {imagePreview ? (
                  <div className="relative mb-4 h-64 w-full overflow-hidden rounded-lg border-2 border-blue-200">
                    <Image
                      src={imagePreview}
                      alt="Hazard preview"
                      fill
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
          <div className="relative mx-4 max-w-md rounded-lg bg-white p-8 shadow-2xl">
            <Button
              variant="ghost"
              size="sm"
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mb-6 text-gray-600">
                Thank you for helping make your community safer. Your report has been submitted and will be reviewed
                shortly.
              </p>
              <Button onClick={closeSuccessMessage} className="bg-blue-600 text-white hover:bg-blue-700">
